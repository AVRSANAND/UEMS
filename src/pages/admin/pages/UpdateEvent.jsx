...
function UpdateEvent() {
  ...
  const { events, setEvents, updateEvent } = context;
        ...
        <div className=" bg-gray-800 px-10 py-10 rounded-xl ">
          ...
          <div>
            <input
              ...
              onChange={(e) =>
                setEvents({ ...events, imageUrl: e.target.value })
              }
              name="imageUrl"
              className=" bg-gray-600 mb-4 px-2 py-2 w-full lg:w-[20em] rounded-lg text-white placeholder:text-gray-200 outline-none"
          ...
          <div className=" flex justify-center mb-3">
            <button onClick={updateEvent} className=" bg-yellow-500 w-full text-black font-bold  px-2 py-2 rounded-lg">
              Update Event
            </button>
          </div>
        </div>
